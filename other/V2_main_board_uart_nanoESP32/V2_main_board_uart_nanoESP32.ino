...
void setup() {
  Serial.begin(9600);
  myNex.begin(9600); // ECRANS
  Serial3.begin(9600); // uart avec nano_esp32 pin RX = 14 et TX = 15
...
void loop() {
  ...
  // Lire les données reçues jusqu'à la fin de la ligne
  String messageRecu = Serial3.readStringUntil('\n');
  // Afficher le message reçu sur le moniteur série
